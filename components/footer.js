  ...
  const legal = [
    {
      ...
      link: "/politicas-de-privacidades",
    },
      ...
      <div className="relative">
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5  lg:grid-cols-5">
          <div className="lg:col-span-3">
            ...
            <div className="w-full max-w-xl mt-4 text-gray-400 ">
        ...
        <div className="my-10 text-sm text-center text-gray-400 ">
          Copyright © {new Date().getFullYear()}. Select Prime Financial
          Solutions. Todos direitos reservados.
        </div>
      </div>
    </Container>
  );
