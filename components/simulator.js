              ...
              >
                ...
                <div className="flex w-full">
                  <button
                    ...
                    className="bg-gray-200 flex mx-auto text-gray-400 border-2 py-2 px-8 focus:outline-none rounded text-lg w-auto"
                  >
                    Alterar Valor
                  </button>
                  <button className="bg-black mx-auto text-white border-2 py-2 px-8 focus:outline-none rounded text-lg w-2/4 text-center">
                    Enviar
                  </button>
                </div>
              </form>
